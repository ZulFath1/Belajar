...
public class Main extends Application {
    ...
    public static void tampilkanCustomer() {
        try {
            FXMLLoader pemuat = new FXMLLoader(Main.class.getResource("/views/Customer.fxml"));
            Parent akar = pemuat.load();
            ...
            mainStage.centerOnScreen(); 
             ...
             System.err.println("Error memuat Customer.fxml. Pastikan file ada di views/.");
             e.printStackTrace();
        }
    }
    
    public static void tampilkanTransaction() {
        try {
            FXMLLoader pemuat = new FXMLLoader(Main.class.getResource("/views/Transaction.fxml"));
            Parent akar = pemuat.load();
            ...
            mainStage.centerOnScreen(); 
             ...
             System.err.println("Error memuat Transaction.fxml. Pastikan file ada di views/.");
             e.printStackTrace();
        }
    }
